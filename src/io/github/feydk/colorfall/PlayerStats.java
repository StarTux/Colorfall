...
public class PlayerStats
{
    ...
    public void loadOverview(ColorfallGame plugin, String name)
    {
        String sql = 
    ...
    public static List<PlayerStats> loadTopWinners(ColorfallGame plugin)
    {
        String sql = 
    ...
    public static List<PlayerStats> loadTopPainters(ColorfallGame plugin)
    {
        String sql = 
    ...
    public static List<PlayerStats> loadTopClockers(ColorfallGame plugin)
    {
        String sql = 
    ...
    public static List<PlayerStats> loadTopPearlers(ColorfallGame plugin)
    {
        String sql = 
    ...
    public static List<PlayerStats> loadTopSnowballers(ColorfallGame plugin)
    {
        String sql = 
    ...
    public static List<PlayerStats> loadTopRandomizers(ColorfallGame plugin)
    {
        String sql = 
    ...
    public static List<PlayerStats> loadTopDeaths(ColorfallGame plugin)
    {
        String sql = 
    ...
    public static List<PlayerStats> loadTopContestants(ColorfallGame plugin)
    {
        String sql = 
